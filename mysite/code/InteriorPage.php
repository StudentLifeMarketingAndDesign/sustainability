...
class InteriorPage extends Page {
 static $db = array(
   ...
   $fields = parent::getCMSFields();
    ...
    $fields->addFieldToTab('Root.Video', new TextField('YouTubeID', 'YouTube ID will embed a video on this page. The ID is at the end of the URL. Example: the last part beginning with q, here: http://www.youtube.com/watch?v=qec8hPzqHBk'));
